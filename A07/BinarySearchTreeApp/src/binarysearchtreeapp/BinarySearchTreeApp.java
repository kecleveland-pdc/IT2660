...
public class BinarySearchTreeApp {
        ...
        try
        {
            ...
            while(endProgram != userInput)
            {
                ...
                if(userInput == 1)
                {
                    ...
                    System.out.println("Inserted " + records.fetch(listing.getKey()));
    ...
    public static BinaryTree InitStudentRecords(int maxDataSet)
    {
        BinaryTree studentRecords = new BinaryTree();
